			...
			<div class="card rounded-0 shadow">
				<div class="card-body">
					<div class="container-fluid">
						...
						?>
						<form method="post" action="admin_edit_book.php?bookisbn=<?php echo $row['book_isbn'];?>" enctype="multipart/form-data">
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<select class="form-select rounded-0"  name="genre_id" required>
										...
										?>
										<option value="<?= $row['genre_id'] ?>" <?= $row['genre_id']==$row['genre_id'] ? 'selected' : '' ?>><?= $row['genre_name'] ?></option>
										<?php endwhile; ?>
									</select>
